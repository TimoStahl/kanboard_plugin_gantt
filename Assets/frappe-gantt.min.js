var Gantt = (function () {
    ...
    class Bar {
        ...
        draw_bar() {
            this.$bar = createSVG('rect', {
                ...
                class: 'bar' + ((typeof this.task.custom_class !== "undefined" && this.task.custom_class) ? ' ' + this.task.custom_class : ''), // patch from https://github.com/frappe/gantt/issues/97
        ...
        draw_resize_handles() {
            ...
            // Kanboard Gantt Plugin -> disable progress handle
    ...
    class Gantt {
        ...
        setup_options(options) {
            ...
            this.options.language = ((typeof month_names[this.options.language] !== "undefined") ? this.options.language : 'en');
        }
